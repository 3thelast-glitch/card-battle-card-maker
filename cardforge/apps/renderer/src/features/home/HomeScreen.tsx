      ...
      <div style={{ display: 'grid', gap: 16, gridTemplateColumns: '1.2fr 1fr' }}>
        <Panel title={t('home.title')} subtitle={t('home.subtitle')}>
          <div className="list">
            ...
            <div>
              ...
              <div className="grid-2" style={{ marginTop: 8 }}>
                {templateOptions.map((tpl) => {
                  ...
                  const tplName = resolveLocalized(tpl.name, lang) || t('home.templateFallback');
                  const tplDesc = resolveLocalized(tpl.description, lang) || t('home.templateFallback');
                  return (
                    <button
                      key={tpl.id}
                      className="list-item"
            ...
            <Row gap={10}>
              <Button onClick={() => props.onCreate(name, templateId)}>{t('home.createProject')}</Button>
        ...
        <Panel title={t('home.recentTitle')} subtitle={t('home.recentSubtitle')}>
          <div className="list">
