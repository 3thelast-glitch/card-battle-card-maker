                    ...
                    <div className="absolute top-0 left-0 right-0 overflow-hidden z-0"
                        ...
                        {data.imageUrl ? (
                            ...
                            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-10"
                                ...
                                {/* Central Eye */}
                                <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-30 rounded-full flex items-center justify-center animate-[pulse_1.5s_ease-in-out_infinite]"
                                    style={{
