...
import {
  ...
  Layout, Grid, Circle
} from 'lucide-react'; // تم استبدال Magic بـ Wand2 وإضافة المفقود

// تأكد من وجود هذه التعريفات قبل استخدامها في المكون
          ...
          <div className="space-y-6 animate-fade-in">
            <div className="grid grid-cols-3 gap-4">
              {[
                ...
                { name: 'Cyber Neon', color: '#00f2ff', style: { color: '#00f2ff', shadowIntensity: 50, glow: 10 } },
