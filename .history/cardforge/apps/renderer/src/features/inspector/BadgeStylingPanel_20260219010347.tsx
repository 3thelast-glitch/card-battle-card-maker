...
import {
  ...
  Layout, Grid, Circle, Github
} from 'lucide-react';

// إضافة التعريف المفقود هنا يحل مشكلة اختفاء الكروت
          ...
          <div className="space-y-6 animate-fade-in">
            <div className="grid grid-cols-3 gap-4">
              {[
                ...
                { name: 'Mythic Purple', color: '#8A2BE2', style: { color: '#8A2BE2', shadowIntensity: 60, glow: 12 } },
                { name: 'Ember', color: '#f97316', style: { color: '#f97316', shadowIntensity: 50, glow: 10 } },
                { name: 'Moon', color: '#94a3b8', style: { color: '#94a3b8', shadowIntensity: 30, glow: 5 } },
