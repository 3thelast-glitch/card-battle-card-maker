        ...
        {selectedBadge ? (
          <div className="flex-1 overflow-y-auto flex flex-col">
            ...
            <div className="px-4 py-3 border-b border-slate-100 flex gap-2">
              ...
              <button 
                ...
                className="flex items-center justify-center gap-2 px-3 py-2 bg-red-50 hover:bg-red-100 text-red-700 rounded-lg transition-colors text-sm font-medium"
                title="Delete Badge"
              >
          ...
          <div className="flex-1 flex flex-col items-center justify-center text-slate-400 p-8 text-center">
            ...
            <div className="mt-6 flex gap-2">
              <button onClick={exportConfig} className="p-2 bg-white border border-slate-200 rounded-lg hover:bg-slate-50 transition-colors" title="Export JSON">
                <Download className="w-4 h-4" />
              </button>
              <label className="p-2 bg-white border border-slate-200 rounded-lg hover:bg-slate-50 cursor-pointer transition-colors" title="Import JSON">
