...
import { 
  ...
  Move, Zap, Shield, Crown, Star, Type
} from 'lucide-react';
          ...
          >
            ...
            >
              ...
              {el.image ? (
                ...
                <>
                  {el.type === 'trait' && <Shield className="w-full h-full text-white drop-shadow-md" />}
                  
                  {el.type === 'icon' && <Zap className="w-full h-full text-white drop-shadow-md" />}
                  ...
                  {el.type === 'orb' && (
                    <div className="w-full h-full rounded-full shadow-lg flex items-center justify-center relative overflow-hidden" style={{ backgroundColor: el.color }}>
                      ...
                      <Star className="w-1/2 h-1/2 text-white/90 drop-shadow-md relative z-10" />
                    </div>
                  )}
                </>
              )}
